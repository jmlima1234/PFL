...
Type "value" if you want to play or "pass" to pass: 
|:
```
...
Remaining pieces for Light pieces player:
 -5 pieces of value 1 (size 3)
 -3 pieces of value 2 (size 4)
 -3 pieces of value 3 (size 5)
 -2 pieces of value 4 (size 6)
 -0 pieces of value 6 (size 7)

Remaining pieces for Dark pieces player:
 -2 pieces of value 1 (size 3)
 -4 pieces of value 2 (size 4)
 -3 pieces of value 3 (size 5)
 -2 pieces of value 4 (size 6)
 -1 pieces of value 6 (size 7)
...
Counter position for Light player: (8, 1)
Counter position for Dark player: (5, 9)

Light player score: 18
Dark player score: 4

No more tiles to remove. Game Over.
Player Light wins!
```
